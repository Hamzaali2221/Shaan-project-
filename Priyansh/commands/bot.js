...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 𝗛𝗔𝗠𝗭𝗔 𝗔𝗟𝗜 𝗛𝗔𝗶🥀🖤", threadID);
   };
...
if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
   ...
   if ((event.body.toLowerCase() == "okay") || (event.body.toLowerCase() == "han ji")) {
     return api.sendMessage("Kya Okay😏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Shaan") || (event.body.toLowerCase() == "@Shayan X.")) {
     return api.sendMessage("𝐒𝐇𝐀𝐀𝐍 𝐓𝐎 𝐌𝐄𝐑𝐀 𝐁𝐎𝐒𝐒 𝐊𝐀 𝐃𝐎𝐒𝐓 𝐇𝐀𝐈🌹 ", threadID);
   };
